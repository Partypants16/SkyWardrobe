...
This repository is split into two standalone versions, both featuring current weather, wardrobe recommendations, and the full Rain & Radar feature set (interactive precipitation radar, rain forecast graph, next-rain summary, hourly timeline, insights, and rain-aware wardrobe advice):
